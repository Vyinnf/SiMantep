...
<body>
    <div class="container-fluid">
        <div class="row">
            {{-- Sidebar --}}
            <nav class="col-md-3 col-lg-2 d-md-block bg-white sidebar shadow-sm py-4 px-0" style="min-height:100vh;">
                <div class="text-center mb-4">
                    <img src="{{ asset('assets-admin/img/profile-default.png') }}" alt="Foto Profil" class="rounded-circle mb-2" width="70" height="70">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('dosen.verifikasi') ? 'active' : '' }}" href="{{ route('dosen.verifikasi') }}">
                            <i class="bi bi-person-check"></i> Verifikasi Pendaftaran PKL
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('dosen.mahasiswa') ? 'active' : '' }}" href="{{ route('dosen.mahasiswa') }}">
                            <i class="bi bi-people"></i> Monitoring Mahasiswa Magang
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('dosen.laporan') ? 'active' : '' }}" href="{{ route('dosen.laporan') }}">
                            <i class="bi bi-journal-text"></i> Koreksi & Revisi Laporan
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('dosen.nilai') ? 'active' : '' }}" href="{{ route('dosen.nilai') }}">
                            <i class="bi bi-clipboard-check"></i> Upload Nilai
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('dosen.notifikasi') ? 'active' : '' }}" href="{{ route('dosen.notifikasi') }}">
